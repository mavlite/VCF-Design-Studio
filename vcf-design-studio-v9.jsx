...
function ClusterCard({ cluster, onChange, onRemove, canRemove, result, isMgmtCluster, injectedEntries, failoverSiteNames, domainHostSplitPct, fleet, instance, domain }) {
  ...
  return (
    <div className="border border-emerald-300 dark:border-emerald-800 bg-white dark:bg-slate-800 rounded-md p-4 mb-3">
      <div className="flex items-center justify-between mb-3">
...
function SitesPanel({ fleet, onChange }) {
  ...
  return (
    <div className="border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm rounded-lg p-5 mb-5">
...
export default function VcfFleetSizer() {
  ...
  return (
    <div
      className="min-h-screen p-6 lg:p-10 text-slate-800 dark:text-slate-200 bg-slate-50 dark:bg-slate-900 print-root"
      style={{
        fontFamily: '"Inter", system-ui, sans-serif',
      }}
    >
...
function FleetSummary({ fleet, fleetResult, onChange }) {
  return (
    <div className="border border-blue-200 dark:border-blue-900 bg-white dark:bg-slate-800 shadow-sm rounded-lg p-6 mb-6">
