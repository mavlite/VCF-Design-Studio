...
const EXPECTED_SYMBOLS = [
  ...
  "createFleetNamingConfig", "createClusterNaming", "createFleetReportMetadata", "createFleetInstallerConfig", "createFleetBackupConfig", "createFleetAdConfig", "createFleetFederationConfig", "createFederationGlobalManagerExtras", "createFederationLocalManager", "createFederationTier1", "createWitnessConfig", "createClusterAz2HostOverlay", "createClusterVsanCompute", "createEdgeCluster", "createEdgeNode", "createVdsLag", "createNetworkIpv6", "baseStorageDataServices", "baseClusterAdvanced", "PRINCIPAL_STORAGE_OPTIONS", "slugify", "resolveTemplate", "mergeNamingConfig", "hostTokensFor", "vdsTokensFor", "vdsSlotPurpose", "resolveHostname", "resolveVdsName", "applyVdsTemplate",
];
