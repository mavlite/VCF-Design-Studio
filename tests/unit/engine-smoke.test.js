...
const EXPECTED_SYMBOLS = [
  ...
  "createFleetNamingConfig", "createClusterNaming", "createFleetReportMetadata", "createFleetInstallerConfig", "createFleetBackupConfig", "baseStorageDataServices", "baseClusterAdvanced", "slugify", "resolveTemplate", "mergeNamingConfig", "hostTokensFor", "vdsTokensFor", "vdsSlotPurpose", "resolveHostname", "resolveVdsName", "applyVdsTemplate",
];
