...
const EXPECTED_SYMBOLS = [
  ...
  "createFleetNamingConfig", "createClusterNaming", "createFleetReportMetadata", "createFleetInstallerConfig", "createFleetBackupConfig", "createFleetAdConfig", "createFleetFederationConfig", "createEdgeCluster", "createEdgeNode", "createVdsLag", "baseStorageDataServices", "baseClusterAdvanced", "PRINCIPAL_STORAGE_OPTIONS", "slugify", "resolveTemplate", "mergeNamingConfig", "hostTokensFor", "vdsTokensFor", "vdsSlotPurpose", "resolveHostname", "resolveVdsName", "applyVdsTemplate",
];
