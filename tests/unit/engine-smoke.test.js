...
const EXPECTED_SYMBOLS = [
  ...
  "createFleetNamingConfig", "createClusterNaming", "createFleetReportMetadata", "createFleetInstallerConfig", "slugify", "resolveTemplate", "mergeNamingConfig", "hostTokensFor", "vdsTokensFor", "vdsSlotPurpose", "resolveHostname", "resolveVdsName", "applyVdsTemplate",
];
