...
const EXPECTED_SYMBOLS = [
  ...
  "SUPPORTED_WORKBOOK_VERSIONS", "VCF_TO_WORKBOOK_VERSION", "workbookVersionForFleet", "WORKBOOK_CELL_MAP", "emitWorkbookCellMap", "emitWorkbookCellMapCsv", "parseWorkbookCellMap",
