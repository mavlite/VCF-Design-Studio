...
//
// vcf-design-studio-v9.html is a generated artifact (engine.js + .jsx stitched
...
console.error("  - engine.js or vcf-design-studio-v9.jsx was edited without re-running build-html, or");
console.error("  - vcf-design-studio-v9.html was edited by hand (it is a generated artifact).");
console.error("");
console.error("Fix:  npm run build-html  &&  git add vcf-design-studio-v9.html");
console.error("");
if (firstDiff >= 0) {
