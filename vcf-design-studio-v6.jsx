  ...
  return (
    <section className="print-page print-section">
      ...
      <p className="print-empty" style={{ fontStyle: "normal", color: "#475569" }}>
        ...
        Dashed blue lines indicate stretched relationships.
      </p>
...
function PrintPhysicalTopology({ fleet, fleetResult }) {
  ...
  return (
    <section className="print-page print-section">
      ...
      <p className="print-empty" style={{ fontStyle: "normal", color: "#475569" }}>
        Per-site rack-level layout showing cluster placement, appliances per cluster,
        and stretched relationships across sites.
      </p>
      <div className="print-svg-container">
        <svg
          viewBox={`0 0 ${layout.width} ${layout.height}`}
                      ...
                      return (
                        <g key={`${site.id}-${dom.id}-${clu.id}`}>
                          ...
                          {(clu.appliances || []).map((app, ai) => {
                            ...
                            return (
                              <g key={`app-${ai}`}>
                                <rect x={app.x} y={site.y + app.y} width={app.width} height={app.height}
                                  rx={3} fill={ac.fill} stroke={ac.stroke} strokeWidth={0.8} />
                                <text x={app.x + 5} y={site.y + app.y + 11}
                                  fontFamily="IBM Plex Mono, monospace" fontSize={8}
                                  fill={ac.text}>{truncate(app.label, 18)}</text>
                              </g>
                            );
                          })}
                        </g>
